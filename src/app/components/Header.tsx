    ...
    return (
        <div className='max-xl:px-3 h-[80px] lg:h-30 text-lg items-center container mx-auto flex max-2xl:justify-between '>
            ...
            <ul className='max-xl:hidden flex gap-7.5 2xl:ml-100.5'>
                ...
                <li ><a className='font-mundial-medium text-[#888C93] hover:text-white' href="">Services</a></li>
                <li ><a className='font-mundial-medium text-[#888C93] hover:text-white' href="">About Us</a></li>
